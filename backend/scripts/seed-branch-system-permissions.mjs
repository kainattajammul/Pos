/**
 * Seeds branch system & audit module permissions.
 * Run: node scripts/seed-branch-system-permissions.mjs
 */
import "dotenv/config";
import { PrismaClient } from "@prisma/client";
import { BRANCH_SYSTEM_PERMISSION_SEED } from "../src/constants/branchSystemPermissions.js";
...
async function main() {
  console.log("\n=== Seed branch system permissions ===\n");
  const all = [
