/**
 * Seeds branch staff module permissions.
 * Run: node scripts/seed-branch-staff-permissions.mjs
 */
...
async function main() {
  console.log("\n=== Seed branch staff permissions ===\n");
  const all = [...BRANCH_PERMISSION_SEED, ...BRANCH_STAFF_PERMISSION_SEED];
